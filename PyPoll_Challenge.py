...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes_dict:
        ...
        if (county_votes > county_turnout) and (county_votes_percentage> largest_county_percentage):
    ...
    winning_county_summary = (
        f"\n-------------------------\n"
        f"Largest County Turnout: {largest_county_turnout} with {county_turnout} votes\n"
        f"-------------------------\n"
    )
